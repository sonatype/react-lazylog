...
import * as styles from "./LazyLogLineContentPart.module.css";
 ...
 */
export class LazyLogLineContentPart extends Component {
  static propTypes = {
    /**
  ...
  render() {
    const { format, part, style, color, content } = this.props;

    return (
      <span className={getClassName(part)} style={{ ...style, color: color }}>
